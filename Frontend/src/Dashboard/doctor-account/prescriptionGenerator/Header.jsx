  ...
  return (
    <>
        <header className="flex flex-col items-center justify-center mb-5 lg:flex-row lg:justify-between">
          <div>
            <h1 className="font-bold uppercase tracking-wide text-4xl mb-3">Prescription</h1>
          </div>
          ...
          {/* <div> 
            /* <ul className="flex items-center justify-between flex-wrap">
              <li>
                <button 
                onClick={handlePrint} 
                className="bg-gray-500 text-white font-bold py-2 px-6 rounded shadow border-2 
                border-gray-500 hover:bg-transparent hover:text-gray-500 transition-all duration-300">
                  Print
                </button></li>
              <li className='mx-2'>
                <button 
                 className="bg-blue-500 text-white font-bold py-2 px-6 rounded shadow border-2 
              ...
              <li>
                <button 
                 className="bg-green-500 text-white font-bold py-2 px-6 rounded shadow border-2 
