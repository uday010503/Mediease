...
import PATIENT_AVATAR02 from '../../assets/images/PATIENT_AVATAR02.png';
import PATIENT_AVATAR03 from '../../assets/images/PATIENT_AVATAR03.jpg';
            ...
            <Swiper modules={[Pagination]} spaceBetween={30} slidesPerView={1} pagination={{ clickable: true }}
                ...
                >
                    ...
                    <SwiperSlide>
                        <div className='py-[30px] px-5 rounded-[13px] '>
                            <div className='flex items-center gap-[13px]'>
                                <img src={PATIENT_AVATAR02} className='h-[60px]'/>
                                <div>
                                    <h4 className='text-[18px] leading-[30px] font-semibold text-headingColor'>
                                       Aahan Sharma 
                                    </h4>
                    ...
                    <SwiperSlide>
                        <div className='py-[30px] px-5 rounded-[13px] '>
                            <div className='flex items-center gap-[13px]'>
                                <img src={PATIENT_AVATAR03} className='h-[50px]'/>
                                <div>
                                    <h4 className='text-[18px] leading-[30px] font-semibold text-headingColor'>
                                       Deepika Singh 
                                    </h4>
